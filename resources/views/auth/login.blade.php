...
<body>
    ...
    <div style="padding:100px;" class="container d-flex justify-content-center align-items-center w-100 vh-100">
        <div class="p-5 w-100 rounded bg-white">
            <div><a style="margin-right:10px;" href='/login'>Login</a><a style="color:grey;" href='/register'>Register</a></div>
    ...
    <footer style="margin-top:-30px; background-color:black; color: white; height:80px; display:flex;justify-content:center; align-items:center;">
        <div>
