    ...
    <div class="row">
        <div style="padding:100px;" class="container d-flex justify-content-center align-items-center w-100 vh-100">
            ...
            <div class="col-lg w-50 h-100" style="margin-left:-800px;">
                ...
                <p>{{$purchasedPlan->plan_name}}</p>
                <h1>${{$purchasedPlan->plan_price}}.00</h1>
                @endforeach
            </div>
        </div>
        ...
        <div class="col-md-4 h-50 p-3 rounded bg-white border" style="margin-left:-1500px;margin-top:100px;">
            <div class="container">
                ...
                <div class="panel-body">
                    ...
                    @endif
                    <form role="form" action="{{route('stripe.post')}}" method="post" class="require-validation" data-cc-on-file="false" id="payment-form">
                        @csrf
                        ...
                        <div class='form-row row'>
                            <div class=' form-group cvc required'>
                                <label class='control-label'>CVC</label> <input autocomplete='off' class='form-control card-cvc' placeholder='ex. 311' type='text'>
                            </div>
                            <div class=' form-group expiration required'>
                                <label class='control-label' style="margin-left: 5px;">Expiration Month</label> <input class='form-control card-expiry-month' style="margin-left: 5px;" placeholder='MM' type='text'>
                            </div>
                            <div class=' form-group expiration required'>
                                <label class='control-label'>Expiration Year</label> <input class='form-control card-expiry-year' placeholder='YYYY' type='text'>
                            </div>
                        </div>
